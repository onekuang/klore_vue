<template>
<div class="address_update page">

	<form @submit.prevent="onSubmit">
		<div class="register_box">
			<div class="username_box">
				<div class="item">收件人:</div>
				<div class="item">
					<input type="text" name="username" placeholder="请输入收件人" v-model="form_data.username">
				</div>
			</div>
			...
			<div class="new_mobile_box">
				<div class="item">选择省市:</div>
				<div class="item" @click="show_pick">
					<!-- <input type="text" class="new_mobile" name="address" placeholder="请输入详细地址" v-model="form_data.shengshi"> -->
					<p class="p1">{{form_data.shengshi || '请选择省市' }}</p>
				</div>	
			</div>
			...
			<div class="new_mobile_box">
				...
				<div class="item">
					<input type="text" class="new_mobile" name="address" placeholder="请输入详细地址" v-model="form_data.address">
				</div>	
			</div>
		</div>
		<div class="khr"></div>
		<div class="btn_box" style="margin-top: 30px;">
			<button class="theme_btn" type="submit">添加地址</button>
		</div>
	</form>


	<div class="picker_box" v-show="picker_show">
	<div class="title">
		<div class="cencel" @click="close_picker(0)">取消</div>
	...
	methods: {
		...
		close_picker(status) {
			if(status == 1) {
				...
				this.form_data.shengshi = this.addressProvince + this.addressCity
			}
