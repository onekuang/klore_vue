...
<k_header title="商户入驻申请" />	


	<div class="radio_head">
		<div class="title">主营行业(单选):</div>
	</div>
	<div class="radio_box">
		<div class="items">
	...
	<div class="k_input_box">
		<div class="k_input">
			...
			<div class="item">
				<input type="text" name="name" placeholder="请填写公司真实名称">
			</div>
		</div>
	</div>
	...
	<div class="k_input_box">
		<div class="k_input">
			<div class="item">法人姓名:</div>
			<div class="item">
				<input type="text" name="name" placeholder="请填写法人真实姓名">
			</div>
		</div>
	</div>
	...
	<div class="k_input_box">
		<div class="k_input">
			<div class="item">法人手机号:</div>
			<div class="item">
				<input type="text" name="name" placeholder="请填写负责人手机号">
			</div>
		</div>
	</div>
  ...
  <div class="upload_wrapper">
	...
	<div class="text_make">
		<div class="text">请上传您的营业执照，法人身份证(正面)，法人身份证(反面)
			<br>我们将在3个工作日内进行审核
		</div>
	</div>
