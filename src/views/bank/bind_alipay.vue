	...
	<form @submit.prevent="onSubmit">
		<div class="register_box">
			<div class="username_box">
				...
				<div class="item">
					<input type="text" name="username" placeholder="请输入真实姓名" v-model="form_data.username">
				</div>
			</div>
			<div class="username_box">
				<div class="item">支付宝号:</div>
				<div class="item">
		...
		<div class="btn_box" style="margin-top: 30px;">
			<button class="theme_btn" type="submit">绑定</button>
		</div>
	</form>
